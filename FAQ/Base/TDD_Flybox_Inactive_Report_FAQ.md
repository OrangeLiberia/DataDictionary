📊 Inactive TDD Flybox Customers Report (Jan–March 2026) – FAQ
📌 Overview

This document explains the logic and structure used to generate the report for Inactive TDD Flybox customers during January–February 2026, labeled for Q1 2026 (Jan–March) analysis.
...
Identifies customers who used Flybox before Jan 2026
Forms the base population
...
February = 28 days
👉 Total = 59 days
❓ Why is March mentioned in the report name?

Although the logic checks Jan–Feb inactivity, it:

Represents Q1 performance tracking
Assumes continued inactivity into March
