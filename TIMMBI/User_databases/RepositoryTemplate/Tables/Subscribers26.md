...
[Project](../../../../index.md) > [192.168.19.120\\BI](../../../index.md) > [User databases](../../index.md) > [RepositoryTemplate](../index.md) > [Tables](Tables.md) > in.Subscribers26

# ![Tables](../../../../Images/Table32.png) [in].[Subscribers26]

---

## <a name="#description"></a>MS_Description

Subscriber Snapshot Day 26

## <a name="#columns"></a>Columns

| Key | Name | Data Type | Max Length (Bytes) | Nullability | Description |
|---|---|---|---|---|---|
| [![Cluster Primary Key PK_Subscribers26: SubsID](../../../../Images/pkcluster.png)](#indexes) | SubsID | int | 4 | NOT NULL | _IN Subscriber ID_ |
...
|---|---|---|---|---|
| [![Cluster Primary Key PK_Subscribers26: SubsID](../../../../Images/pkcluster.png)](#indexes) | PK_Subscribers26 | SubsID | YES | IN |
