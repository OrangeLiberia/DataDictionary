...
[Project](../../../../index.md) > [192.168.19.11\\MEDIBLNG](../../../index.md) > [User databases](../../index.md) > [TIMM_DMP_TAP](../index.md) > [Tables](Tables.md) > dbo.Inbound_MOC

# ![Tables](../../../../Images/Table32.png) [dbo].[Inbound_MOC]
...
|---|---|---|---|---|
| [![Cluster Primary Key PK_DMP_Inbound_MOC: BatchID\ID](../../../../Images/pkcluster.png)](#indexes)[![Indexes IX_ExporterMoveToWorkItems](../../../../Images/Index.png)](#indexes) | BatchID | bigint | 8 | NOT NULL |
| [![Cluster Primary Key PK_DMP_Inbound_MOC: BatchID\ID](../../../../Images/pkcluster.png)](#indexes)[![Indexes IX_ExporterMoveToWorkItems](../../../../Images/Index.png)](#indexes) | ID | int | 4 | NOT NULL |
|  | WF_STATE | int | 4 | NOT NULL |
| [![Indexes IX_IDOperator](../../../../Images/Index.png)](#indexes) | IDOperator | bigint | 8 | NULL allowed |
...
| [![Indexes IX_IMSI](../../../../Images/Index.png)](#indexes) | A_IMSI | varchar(32) | 32 | NULL allowed |
...
IX_DATE_BEGIN_CALL](../../../../Images/Index.png)](#indexes)(2) | Date_Begin_Call | datetime | 8 | NULL allowed |
